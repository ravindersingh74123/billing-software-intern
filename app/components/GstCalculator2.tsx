...
export default function GstCalculator() {
  ...
  return (
    <div className="min-h-screen bg-slate-50 dark:bg-zinc-950 text-slate-900 dark:text-zinc-100 transition-colors duration-300">
      {/* ========================= HEADER ========================= */}
      <div className="border-b border-slate-200 dark:border-zinc-800 bg-white/80 dark:bg-zinc-900/80 backdrop-blur">
        <div className="mx-auto max-w-6xl px-4 py-8 text-center sm:px-6 lg:px-8">
          <h1 className="mt-4 text-3xl font-bold tracking-tight sm:text-4xl text-slate-900 dark:text-zinc-100">
            GST Calculator
          </h1>

          <p className="mx-auto mt-3 max-w-2xl text-sm leading-6 text-slate-600 dark:text-zinc-400 sm:text-base">
      ...
      <main className="mx-auto max-w-6xl px-4 py-8 sm:px-6 lg:px-8">
        <div className="grid gap-8">
          {/* ========================= GST CALCULATOR ========================= */}
          <section className="overflow-hidden rounded-3xl border border-slate-200 dark:border-zinc-800 bg-white dark:bg-zinc-900 shadow-xl shadow-slate-200/60 dark:shadow-none">
            <div className="border-b border-slate-100 dark:border-zinc-800 bg-gradient-to-r from-emerald-50 to-teal-50 dark:from-emerald-950/20 dark:to-teal-950/20 px-6 py-5 sm:px-8">
              <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
                <div>
                  <p className="text-xs font-semibold uppercase tracking-[0.2em] text-emerald-600 dark:text-emerald-400">
                    GST Calculator
                  </p>
                  <h2 className="mt-1 text-2xl font-bold text-slate-900 dark:text-zinc-100">
                    Calculate GST instantly
                  </h2>
                </div>
                <div className="rounded-full bg-white dark:bg-zinc-800 px-4 py-2 text-sm font-medium text-slate-700 dark:text-zinc-300 shadow-sm ring-1 ring-slate-200 dark:ring-zinc-700">
                  Exclusive / Inclusive
                </div>
              </div>
            </div>
            ...
            <div className="px-6 py-6 sm:px-8">
              <div className="grid gap-5 md:grid-cols-3">
                ...
                <div className="space-y-2">
                  ...
                  <input
                    type="number"
                    className="w-full rounded-2xl border border-slate-300 dark:border-zinc-700 bg-white dark:bg-zinc-800 px-4 py-3 text-slate-900 dark:text-zinc-100 outline-none transition focus:border-emerald-500 focus:ring-4 focus:ring-emerald-100 dark:focus:ring-emerald-900/30"
              ...
              <div className="mt-8 grid gap-4 sm:grid-cols-3">
                <div className="rounded-2xl border border-slate-200 dark:border-zinc-800 bg-slate-50 dark:bg-zinc-800/50 p-5 text-center">
                  <p className="text-sm text-slate-500 dark:text-zinc-400">Actual Amount</p>
                  <p className="mt-2 text-2xl font-bold tracking-tight text-slate-900 dark:text-zinc-100">
                    ₹{gstResult.actual.toFixed(2)}
                  </p>
                </div>

                <div className="rounded-2xl border border-emerald-200 dark:border-emerald-900/50 bg-emerald-50 dark:bg-emerald-900/20 p-5 text-center">
                  <p className="text-sm text-emerald-700 dark:text-emerald-400">GST Amount</p>
                  <p className="mt-2 text-2xl font-bold tracking-tight text-emerald-700 dark:text-emerald-400">
                    ₹{gstResult.gstAmount.toFixed(2)}
                  </p>
                </div>

                <div className="rounded-2xl border border-blue-200 dark:border-blue-900/50 bg-blue-50 dark:bg-blue-900/20 p-5 text-center">
                  <p className="text-sm text-blue-700 dark:text-blue-400">Total Amount</p>
                  <p className="mt-2 text-2xl font-bold tracking-tight text-blue-700 dark:text-blue-400">
          ...
          {/* ========================= PROFIT CALCULATOR ========================= */}
          <section className="overflow-hidden rounded-3xl border border-slate-200 dark:border-zinc-800 bg-white dark:bg-zinc-900 shadow-xl shadow-slate-200/60 dark:shadow-none">
            <div className="border-b border-slate-100 dark:border-zinc-800 bg-gradient-to-r from-indigo-50 to-sky-50 dark:from-indigo-950/20 dark:to-sky-950/20 px-6 py-5 sm:px-8">
              <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
                <div>
            ...
            <div className="px-6 py-6 sm:px-8">
              <div className="grid gap-5 md:grid-cols-3">
                ...
                <div className="space-y-2">
                  ...
                  <input
                    type="number"
                    className="w-full rounded-2xl border border-slate-300 dark:border-zinc-700 bg-white dark:bg-zinc-800 px-4 py-3 text-slate-900 dark:text-zinc-100 outline-none transition focus:border-indigo-500 focus:ring-4 focus:ring-indigo-100 dark:focus:ring-indigo-900/30"
                    value={cost}
              ...
              <div className="mt-8 grid gap-4 sm:grid-cols-2 xl:grid-cols-4">
                <div className="rounded-2xl border border-emerald-200 dark:border-emerald-900/50 bg-emerald-50 dark:bg-emerald-900/20 p-5 text-center">
                  <p className="text-sm text-emerald-700 dark:text-emerald-400">Profit</p>
                  <p className="mt-2 text-2xl font-bold tracking-tight text-emerald-700 dark:text-emerald-400">
                ...
                <div className="rounded-2xl border border-slate-200 dark:border-zinc-800 bg-slate-50 dark:bg-zinc-800/50 p-5 text-center">
                  <p className="text-sm text-slate-500 dark:text-zinc-400">GST Paid</p>
                  <p className="mt-2 text-2xl font-bold tracking-tight text-slate-900 dark:text-zinc-100">
                ...
                <div className="rounded-2xl border border-slate-200 dark:border-zinc-800 bg-slate-50 dark:bg-zinc-800/50 p-5 text-center">
                  <p className="text-sm text-slate-500 dark:text-zinc-400">GST Collected</p>
                  <p className="mt-2 text-2xl font-bold tracking-tight text-slate-900 dark:text-zinc-100">
                ...
                <div className="rounded-2xl border border-blue-200 dark:border-blue-900/50 bg-blue-50 dark:bg-blue-900/20 p-5 text-center">
                  <p className="text-sm text-blue-700 dark:text-blue-400">GST Payable</p>
                  <p className="mt-2 text-2xl font-bold tracking-tight text-blue-700 dark:text-blue-400">
              ...
              <div className="mt-10 grid gap-6 lg:grid-cols-3">
                {/* Profit Percentage */}
                <div className="rounded-2xl border border-slate-200 dark:border-zinc-800 bg-slate-50 dark:bg-zinc-800/50 p-5">
                  <label className="text-sm font-semibold text-slate-700 dark:text-zinc-300">
                    Profit Percentage (%)
                  </label>
                  <input
                    type="number"
                    className="mt-2 w-full rounded-2xl border border-slate-300 dark:border-zinc-700 bg-white dark:bg-zinc-800 px-4 py-3 text-slate-900 dark:text-zinc-100 outline-none transition focus:border-indigo-500 focus:ring-4 focus:ring-indigo-100 dark:focus:ring-indigo-900/30"
                ...
                {/* Predicted Selling Price */}
                <div className="rounded-2xl border border-indigo-200 dark:border-indigo-900 bg-indigo-50 dark:bg-indigo-900/20 p-5">
                  <label className="text-sm font-semibold text-indigo-700 dark:text-indigo-400">
                    Predicted Selling Price
                  </label>
                  <input
                    type="number"
                    className="mt-2 w-full rounded-2xl border border-indigo-200 dark:border-indigo-800 bg-white dark:bg-zinc-800 px-4 py-3 text-slate-900 dark:text-zinc-100 outline-none"
                    value={predictedResult.predictedSellingPrice.toFixed(2)}
                    readOnly
                  />
                  <p className="mt-3 text-xs leading-5 text-indigo-700/80 dark:text-indigo-400/80">
              ...
              <div className="mt-6 grid gap-4 md:grid-cols-3">
                <div className="rounded-2xl border border-slate-200 dark:border-zinc-800 bg-white dark:bg-zinc-900 p-5 shadow-sm">
                  <p className="text-sm text-slate-500 dark:text-zinc-400">Actual Cost</p>
                ...
                <div className="rounded-2xl border border-slate-200 dark:border-zinc-800 bg-white dark:bg-zinc-900 p-5 shadow-sm">
                  <p className="text-sm text-slate-500 dark:text-zinc-400">Base Selling Price</p>
                  <p className="mt-1 text-xl font-bold text-slate-900 dark:text-zinc-100">
                    ₹{predictedResult.baseSellingPrice.toFixed(2)}
                  </p>
                </div>

                <div className="rounded-2xl border border-emerald-200 dark:border-emerald-900 bg-emerald-50 dark:bg-emerald-900/20 p-5 shadow-sm">
          ...
          <section className="rounded-3xl border border-slate-200 dark:border-zinc-800 bg-white dark:bg-zinc-900 p-6 shadow-lg shadow-slate-200/50 dark:shadow-none sm:p-8">
            {/* HEADER */}
            <div className="text-center">
              ...
              <h2 className="mt-2 text-3xl font-bold text-slate-900 dark:text-zinc-100">
                How to Use the GST Calculator
              </h2>

              <p className="mx-auto mt-4 max-w-3xl leading-7 text-slate-600 dark:text-zinc-400">
            ...
            <div className="mt-10 grid gap-5 md:grid-cols-3">
              {/* Step 1 */}
              <div className="rounded-2xl border border-slate-200 dark:border-zinc-800 bg-slate-50 dark:bg-zinc-800/50 p-5">
                <div className="flex h-12 w-12 items-center justify-center rounded-2xl bg-indigo-100 dark:bg-indigo-900/30 text-lg font-bold text-indigo-700 dark:text-indigo-400">
                  1
                </div>

                <h3 className="mt-4 text-lg font-bold text-slate-900 dark:text-zinc-100">
                  Enter Amount
                </h3>
              ...
              {/* Step 2 */}
              <div className="rounded-2xl border border-slate-200 dark:border-zinc-800 bg-slate-50 dark:bg-zinc-800/50 p-5">
                <div className="flex h-12 w-12 items-center justify-center rounded-2xl bg-emerald-100 dark:bg-emerald-900/30 text-lg font-bold text-emerald-700 dark:text-emerald-400">
                  2
                </div>
              ...
              {/* Step 3 */}
              <div className="rounded-2xl border border-slate-200 dark:border-zinc-800 bg-slate-50 dark:bg-zinc-800/50 p-5">
                <div className="flex h-12 w-12 items-center justify-center rounded-2xl bg-blue-100 dark:bg-blue-900/30 text-lg font-bold text-blue-700 dark:text-blue-400">
                  3
                </div>
            ...
            {/* EXAMPLE SECTION */}
            <div className="mt-10 rounded-3xl border border-emerald-200 dark:border-emerald-800 bg-gradient-to-r from-emerald-50 to-teal-50 dark:from-emerald-950/20 dark:to-teal-950/20 p-6">
              <div className="flex flex-col gap-6 lg:flex-row lg:items-center lg:justify-between">
                ...
                <div className="max-w-2xl">
                  ...
                  <h3 className="mt-2 text-2xl font-bold text-slate-900 dark:text-zinc-100">
                  ...
                  <div className="mt-5 space-y-3">
                    <div className="rounded-2xl bg-white/80 dark:bg-zinc-800/80 p-4 shadow-sm border border-white/20 dark:border-zinc-700/50">
                ...
                <div className="grid gap-4 sm:grid-cols-2 lg:w-[360px]">
                  <div className="rounded-2xl border border-white/60 dark:border-zinc-700 bg-white/90 dark:bg-zinc-800 p-5 text-center shadow-sm">
                    <p className="text-sm text-slate-500 dark:text-zinc-400">Actual Amount</p>

                    <p className="mt-2 text-3xl font-bold text-slate-900 dark:text-zinc-100">
                      ₹100
                    </p>
                  </div>

                  <div className="rounded-2xl border border-white/60 dark:border-zinc-700 bg-white/90 dark:bg-zinc-800 p-5 text-center shadow-sm">
                    <p className="text-sm text-emerald-700 dark:text-emerald-400">GST Amount (18%)</p>
                  ...
                  <div className="sm:col-span-2 rounded-2xl border border-white/60 dark:border-zinc-700 bg-white/90 dark:bg-zinc-800 p-5 text-center shadow-sm">
                    <p className="text-sm text-blue-700 dark:text-blue-400">Total Amount</p>
            ...
            <div className="mt-10 rounded-3xl border border-indigo-200 dark:border-indigo-800 bg-gradient-to-r from-indigo-50 to-blue-50 dark:from-indigo-950/20 dark:to-blue-950/20 p-6">
              <div className="flex flex-col gap-6 lg:flex-row lg:items-center lg:justify-between">
                {/* LEFT CONTENT */}
                <div className="max-w-2xl">
                  ...
                  <p className="mt-4 leading-7 text-slate-700 dark:text-zinc-300">
                ...
                {/* RIGHT SIDE EXAMPLE */}
                <div className="w-full max-w-md rounded-3xl border border-white/70 dark:border-zinc-700 bg-white/90 dark:bg-zinc-800 p-6 shadow-lg">
                  <h4 className="text-lg font-bold text-slate-900 dark:text-zinc-100">Example</h4>

                  <div className="mt-5 space-y-4">
                    <div className="flex items-center justify-between rounded-2xl bg-slate-50 dark:bg-zinc-700/50 px-4 py-3">
                      <span className="text-sm text-slate-600 dark:text-zinc-400">Cost Price</span>

                      <span className="font-bold text-slate-900 dark:text-zinc-100">₹100</span>
                    </div>
                    ...
                    <div className="flex items-center justify-between rounded-2xl bg-slate-50 dark:bg-zinc-700/50 px-4 py-3">
                      ...
                      <span className="font-bold text-emerald-700 dark:text-emerald-400">₹50</span>
                    </div>

                    <div className="flex items-center justify-between rounded-2xl bg-slate-50 dark:bg-zinc-700/50 px-4 py-3">
                      <span className="text-sm text-slate-600 dark:text-zinc-400">GST Rate</span>

                      <span className="font-bold text-slate-900 dark:text-zinc-100">18%</span>
                    </div>

                    <div className="rounded-2xl border border-indigo-200 dark:border-indigo-800 bg-indigo-50 dark:bg-indigo-900/40 p-5 text-center">
                      <p className="text-sm text-indigo-700 dark:text-indigo-300">
                        Predicted Selling Price
                      </p>

                      <p className="mt-2 text-4xl font-bold text-indigo-700 dark:text-indigo-400">
                        ₹177
                      </p>
              ...
              <div className="mt-8 grid gap-5 md:grid-cols-3">
                ...
                <div className="rounded-2xl border border-orange-200 dark:border-orange-800 bg-orange-50 dark:bg-orange-950/20 p-5">
                  <h4 className="text-lg font-bold text-orange-800 dark:text-orange-400">
                    📊 Profit Percentage
                  </h4>

                  <p className="mt-2 text-sm leading-6 text-orange-700 dark:text-orange-300">
                ...
                <div className="rounded-2xl border border-blue-200 dark:border-blue-800 bg-blue-50 dark:bg-blue-950/20 p-5">
                  <h4 className="text-lg font-bold text-blue-800 dark:text-blue-400">
                    🧾 Base Selling Price
                  </h4>
            ...
            <div className="mt-10 grid gap-5 md:grid-cols-2">
              <div className="rounded-2xl border border-orange-200 dark:border-orange-800 bg-orange-50 dark:bg-orange-950/20 p-5">
                ...
                <p className="mt-3 text-sm leading-6 text-orange-700 dark:text-orange-300">
                  Inclusive prices already contain GST inside the amount.
                  Exclusive prices add GST separately after calculation.
                </p>
              </div>

              <div className="rounded-2xl border border-purple-200 dark:border-purple-800 bg-purple-50 dark:bg-purple-950/20 p-5">
                <h3 className="text-lg font-bold text-purple-800 dark:text-purple-400">
                  📈 Profit Calculation
                </h3>

                <p className="mt-3 text-sm leading-6 text-purple-700 dark:text-purple-300">
          ...
          <section className="rounded-3xl border border-slate-200 dark:border-zinc-800 bg-white dark:bg-zinc-900 p-6 shadow-lg shadow-slate-200/50 dark:shadow-none sm:p-8">
            ...
            <div className="mt-10 grid gap-5 md:grid-cols-2 xl:grid-cols-3">
              ...
              {/* Inclusive GST */}
              <div className="rounded-2xl border border-emerald-200 dark:border-emerald-800 bg-emerald-50 dark:bg-emerald-950/10 p-5">
                <div className="mb-3 text-3xl">💰</div>
                ...
                <div className="mt-4 rounded-xl bg-white/80 dark:bg-zinc-800/80 p-3 text-sm font-medium text-emerald-800 dark:text-emerald-300 border border-emerald-100 dark:border-emerald-800/50">
              ...
              {/* Exclusive GST */}
              <div className="rounded-2xl border border-blue-200 dark:border-blue-800 bg-blue-50 dark:bg-blue-950/10 p-5">
                <div className="mb-3 text-3xl">🧾</div>
                ...
                <div className="mt-4 rounded-xl bg-white/80 dark:bg-zinc-800/80 p-3 text-sm font-medium text-blue-800 dark:text-blue-300 border border-blue-100 dark:border-blue-800/50">
                  Example: ₹100 + 18% GST
                  <br />
                  GST = ₹18
                  <br />
              ...
              {/* Input Tax Credit */}
              <div className="rounded-2xl border border-purple-200 dark:border-purple-800 bg-purple-50 dark:bg-purple-950/10 p-5">
                <div className="mb-3 text-3xl">🔄</div>
              ...
              {/* GST Slabs */}
              <div className="rounded-2xl border border-orange-200 dark:border-orange-800 bg-orange-50 dark:bg-orange-950/10 p-5">
                <div className="mb-3 text-3xl">📊</div>
                ...
                <div className="mt-4 grid grid-cols-2 gap-3">
                  {[0, 5, 12, 18, 28].map((rate) => (
                    <div
                      key={rate}
                      className="rounded-xl bg-white dark:bg-zinc-800 px-4 py-3 text-center shadow-sm border border-slate-100 dark:border-zinc-700"
                    >
              ...
              {/* Profit Tip */}
              <div className="rounded-2xl border border-rose-200 dark:border-rose-800 bg-rose-50 dark:bg-rose-950/10 p-5">
                <div className="mb-3 text-3xl">📈</div>

                <h3 className="text-lg font-bold text-rose-800 dark:text-rose-400">Profit Tip</h3>
            ...
            {/* BOTTOM NOTE */}
            <div className="mt-10 rounded-2xl border border-slate-200 dark:border-zinc-800 bg-slate-50 dark:bg-zinc-800/50 p-5">
              <h3 className="text-lg font-bold text-slate-900 dark:text-zinc-100">
                Quick Summary
              </h3>
